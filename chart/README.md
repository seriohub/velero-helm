...
| coreService.deployment.image.repository | string | `"vui-core-open/vui-core-open"` | Repository of the Core service container image |
...
| uiService.deployment.image.tag | string | `"0.2.5"` | Tag of the UI container image |
